...
namespace MrPitiful.BoardGame.Base.Test
{
    public class GameObjectApiShould
    {
        ...
        public async void GetSetAndClearAStateProperty()
        {
            ...
            response = await _client.GetAsync(string.Format("/api/genericGameObject/SetStateProperty/{0}/{1}?propertyValue={2}", createdGameObject.Id, propertyName, WebUtility.HtmlEncode(setValue)));
            response.Dispose();
