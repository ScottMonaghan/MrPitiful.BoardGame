    ...
    public class Player
    {
        ...
        public void DoAggressivePlayerTurn(Random rnd)
        {
            ...
            if (target != null)
            {
                ...
                House.Seat.Attack(target, rnd, false, 0.5, 0.9);
            }
        }
        ...
        public void ChangeLordshipLordMenu(Lordship lordship)
        {
            ...
            var nobleHouseholds = subjectHouse.Lordships.SelectMany(l => l.Households.Where(h => h.HeadofHousehold.Class == SocialClass.Noble)).ToList();
        ...
        public void LordshipMenu(Lordship subjectLordship, Random rnd)
        {
            ...
            {
                Console.WriteLine("[D]etails, [H]ouse, House [N]obles, [M]ap, [C]onscript, Dischar[g]e, [A]ttack, [S]ummon, Change [L]ord, E[x]it " + subjectLordship.Name);
                    ...
                    case "attack":
                        {
                            ...
                            else
                            {
                                ...
                                //    .ToList();
                                var attackableLordships = subjectLordship.GetAttackableLordships();
                                var targetNumber = -1;
                                var attackCommand = "";
                    ...
                    case "summon":
                        {
                            ...
                            while (!(numberOfTroopsToSummon >= 0 && numberOfTroopsToSummon <= (summoned.EligibleForConscription.Count() + summoned.Army.Count())))
                            {
            ...
            while (input.ToLower() != "i")
            {
                ...
                if (input.ToLower() != "i")
                {
                    ...
                    if (subjectHouse != null)
                    {
                        ...
                        {
                            Console.WriteLine("House " + subjectHouse.Name + ": [D]etails, [N]obles, [M]ap, [L]ordships, E[x]it " + subjectHouse.Name);
